# Dactyl with Arduino Pro Micro - JP
...
## Build the Firmware:
  ...
  - Build the firmware with `make handwired/dactyl_jp:<keymapname>`, for example `make handwired/dactyl:default`
  - This will result in a hex file called `handwired_dactyl_jp_<keymapname>.hex`, e.g.
    `handwired_dactyl_jp_default.hex`
